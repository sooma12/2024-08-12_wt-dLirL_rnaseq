...
#SBATCH --output=/work/geisingerlab/Mark/rnaSeq/2024-08-12_wt-dLirL_rnaseq/logs/%x-%A-%a.log
#SBATCH --error=/work/geisingerlab/Mark/rnaSeq/2024-08-12_wt-dLirL_rnaseq/logs/%x-%A-%a.err
